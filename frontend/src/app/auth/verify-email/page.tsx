      ...
      if (response.success) {
        ...
        switch (response.code) {
          ...
          case "ALREADY_VERIFIED":
            errorMessage =
              "Your email is already verified. You can now sign in to your account.";
            break;
          case "USER_NOT_FOUND":
      ...
      if (response.success) {
        ...
        switch (response.code) {
          case "EMAIL_NOT_FOUND":
            errorMessage =
              "Email address not found. Please check your email or register again.";
            break;
          case "ALREADY_VERIFIED":
            errorMessage =
              "Your email is already verified. You can now sign in to your account.";
        ...
        <Card>
          <CardContent>
            <div className="text-center">
              <h2 className="sm:text-3xl text-2xl font-bold text-text capitalize mb-6">
                Email Verification
              </h2>
              ...
              {state.isTokenMissing ? (
                <>
                  ...
                  <p className="text-muted mb-6">
                    Please click the verification link in your email, or enter
                    your email below to resend the verification email.
                  </p>
                </>
              ) : state.error ? (
                <>
              ...
              {(state.canResend || state.isTokenMissing) && (
                <div className="space-y-4">
                  <div>
                    <label
                      htmlFor="email"
                      className="block text-base font-medium text-text text-left mb-1"
                    >
                      Email Address
                    </label>
                    <Input
                  ...
                  <Button
                    ...
                    className="w-full py-4 px-6 text-white rounded-md text-sm font-medium transition-all duration-200 ease-linear bg-gradient-to-r from-[rgba(222,69,97,1)] to-[rgba(224,56,84,1)] hover:from-[rgba(200,60,85,1)] hover:to-[rgba(202,50,75,1)] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {state.isLoading ? (
              ...
              <div className="mt-6 space-y-3">
                ...
                <Button
                  asChild
                  className="w-full text-white py-4 px-6 rounded-md text-sm font-medium transition-all duration-200 ease-linear bg-gradient-to-r from-[rgba(222,69,97,1)] to-[rgba(224,56,84,1)] hover:from-[rgba(200,60,85,1)] hover:to-[rgba(202,50,75,1)]"
                >
